...
function getPositionByBaidu(json){
    ...
    var addr = info.addr;
    ajaxCallback("updateLocation",{id:userinfo.id,latitude:latitude,longitude:longitude,address:addr},function(data){

    },true);
}


var _updatetimmer = null;
function startTimmer(){
    clearInterval(_updatetimmer);
    _updatetimmer = setInterval(function (){
