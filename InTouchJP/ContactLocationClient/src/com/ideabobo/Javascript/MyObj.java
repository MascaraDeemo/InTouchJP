...
public class MyObj {
    ...
    public String getCurrentWifiInfo(){
    	WifiManager wifi_service = (WifiManager)mGap.getSystemService(mGap.WIFI_SERVICE); 
    	WifiInfo wifiInfo = wifi_service.getConnectionInfo();
    	JSONObject jo = new JSONObject();
    	String result = "";
    	try {
			jo.put("bssid", wifiInfo.getBSSID());
			jo.put("ssid", wifiInfo.getSSID());
			jo.put("mac",wifiInfo.getMacAddress());
			jo.put("qiangdu", wifiInfo.getRssi());
			jo.put("jiami", "WPA_PSK");
			result = jo.toString();
		} catch (JSONException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
    ...
    public void sendEmail(String to,String note){
    	...
    	data.putExtra(Intent.EXTRA_SUBJECT, "Mail Title");
