	...
	public class FilesystemOnlyAcquaintanceDataSource : IDataSource<Acquaintance>
	{
		...
		static List<Acquaintance> GenerateAcquaintances()
		{
			return new List<Acquaintance>()
			{
				...
				new Acquaintance() { Id = "31bf6fe5-18f1-4354-9571-2cdecb0c00af", FirstName = "Joan", LastName = "Mancum", Company = "Bay Unified School District", JobTitle = "Principal", Email = "joan.mancum@busd.org", Phone = "914-870-7670", Street = "448 Grand Ave", City = "South San Francisco", PostalCode = "94080", State = "CA", PhotoUrl = "https://acquaint.blob.core.windows.net/images/joanmancum.jpg" },
				...
				new Acquaintance() { Id = "c9ebe513-0db2-41d3-b595-20a49454a421", FirstName = "Michelle", LastName = "Wilson", Company = "Evergreen Mechanical", JobTitle = "Sales Manager", Email = "mwilson@evergreenmech.com", Phone = "917-245-7975", Street = "208 Jackson St", City = "San Jose", PostalCode = "95112", State = "CA", PhotoUrl = "https://acquaint.blob.core.windows.net/images/michellewilson.jpg" },
				...
				new Acquaintance() { Id = "00F8A566-2538-4AF7-AE10-997B61537DC0", FirstName = "Leon", LastName = "Muks", Company = "Spacey", JobTitle = "President", Email = "leon.muks@spacey.io", Phone = "310-586-0181", Street = "2518 Durant Ave", City = "Berkeley", PostalCode = "94704", State = "CA", PhotoUrl = "https://acquaint.blob.core.windows.net/images/leonmuks.jpg" },
				new Acquaintance() { Id = "FEB64319-1222-4C76-A8E5-EDFF84838B43", FirstName = "Floyd", LastName = "Bell", Company = "Netcore", JobTitle = "Procurement", Email = "floyd.bell@netcore.net", Phone = "603-226-4115", Street = "450 15th St", City = "Oakland", PostalCode = "94612", State = "CA", PhotoUrl = "https://acquaint.blob.core.windows.net/images/floydbell.jpg" },
				new Acquaintance() { Id = "4FB56717-D2CF-4A5F-894A-C87383A8239D", FirstName = "Vanessa", LastName = "Thornton", Company = "Total Sources", JobTitle = "Product Manager", Email = "vanessa.thornton@totalsourcesinc.com", Phone = "419-998-6611", Street = "550 Quarry Rd", City = "San Carlos", PostalCode = "94070", State = "CA", PhotoUrl = "https://acquaint.blob.core.windows.net/images/vanessathornton.jpg" },
				new Acquaintance() { Id = "89149CDA-5B31-4B15-88D2-6011B028F7AE", FirstName = "John", LastName = "Boone", Company = "A. L. Price", JobTitle = "Executive Associate", Email = "jboone@alpricellc.com", Phone = "973-579-4610", Street = "233 E Harris Ave", City = "South San Francisco", PostalCode = "94080", State = "CA", PhotoUrl = "https://acquaint.blob.core.windows.net/images/johnboone.jpg" },
				...
				new Acquaintance() { Id = "CF568F71-C4B6-45A9-A922-C9E69EF17B49", FirstName = "Joseph", LastName = "Meeks", Company = "Rose Records", JobTitle = "Manager", Email = "jmeeks@roserecordsllc.com", Phone = "978-628-6826", Street = "28 N 1st St", City = "San Jose", PostalCode = "95113", State = "CA", PhotoUrl = "https://acquaint.blob.core.windows.net/images/josephmeeks.jpg" },
				...
				new Acquaintance() { Id = "6CF4DE3E-FE50-4860-8E5C-6DCF479D4737", FirstName = "Evan", LastName = "Armstead", Company = "City of Richmond", JobTitle = "Board Member", Email = "evan.armstead@richmond.org", Phone = "415-336-2228", Street = "398 23rd St", City = "Richmond", PostalCode = "94804", State = "CA", PhotoUrl = "https://acquaint.blob.core.windows.net/images/evanarmstead.jpg" },
